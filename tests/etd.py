...
from pyuntl.etd_ms_structure import (ETD_MSElement, ETD_MS, ETD_MSTitle,
                                     ETD_MS_StructureException,
                                     contributor_director,
                                     description_director, date_director,
                                     identifier_director, subject_director)
...
class TestETD(unittest.TestCase):
    ...
    def testCreateETDElement(self):
        """Test to make sure ETD elements can be created
        and content filled.
        """
    ...
    def testAddBadChildToETDMS(self):
        ...
        self.assertRaises(ETD_MS_StructureException,
                          etd.add_child,
                          etd_bad_child)

    def testContributorDirector(self):
        """Test contributor expansion."""
    ...
    def testIdentifierDirector(self):
        ...
        self.assertEqual(etd.content,
                         'http://digital.library.unt.edu/ark:/67531/metadc271729')
